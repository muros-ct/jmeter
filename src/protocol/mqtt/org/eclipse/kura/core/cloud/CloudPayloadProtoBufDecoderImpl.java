...
public class CloudPayloadProtoBufDecoderImpl {
     ...
     * @throws IOException
     */
    public KuraPayload buildFromByteArray() throws IOException, Exception {
    ...
    private Object getProtoKuraMetricValue(KuraPayloadProto.KuraPayload.KuraMetric metric,
            KuraPayloadProto.KuraPayload.KuraMetric.ValueType type) throws Exception {
        switch (type) {
